...
def plot_score_tradeoff(
    ...
    *,
    ...
    """Scatter a small experiment summary table.

    Experiments pass rows of plain dictionaries; plotting style stays
    centralized here instead of being redefined in each experiment.
    """
